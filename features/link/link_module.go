...
func GetAllPosts() ([]LinkPost, error) {
	ctx, cancel := utils.GetDBContext()
	defer cancel()
...
func GetPostsPaginated(page, limit int, category, search string) ([]LinkPost, error) {
	ctx, cancel := utils.GetDBContext()
	defer cancel()
...
func GetPostByID(id primitive.ObjectID) (*LinkPost, error) {
	ctx, cancel := utils.GetDBContext()
	defer cancel()
...
func InsertPost(post LinkPost) (interface{}, error) {
	ctx, cancel := utils.GetDBContext()
	defer cancel()
	collection := config.Database.Collection("link_posts")
...
func UpdatePost(id primitive.ObjectID, post LinkPost) error {
	ctx, cancel := utils.GetDBContext()
	defer cancel()
