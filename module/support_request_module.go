...
func InsertSupportRequest(req *models.SupportRequestRequest) interface{} {
	...
	insertedID, err := InsertDocument("supportRequests", newRequest)
	if err != nil {
		fmt.Println(err)
		return nil
	}
...
func GetAllSupportRequests() ([]models.SupportRequest, error) {
