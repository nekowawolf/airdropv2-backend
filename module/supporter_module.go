...
func GetAllSupporters() ([]models.Supporter, error) {
...
func GetSupporterByID(id primitive.ObjectID) (*models.Supporter, error) {
	ctx, cancel := utils.GetDBContext()
	defer cancel()
...
func InsertSupporter(supporter *models.Supporter) interface{} {
	newSupporter := models.Supporter{
	...
	insertedID, err := InsertDocument("supporters", newSupporter)
	if err != nil {
		fmt.Println(err)
		return nil
	}
...
func UpdateSupporterByID(id primitive.ObjectID, req *models.Supporter) error {
	ctx, cancel := utils.GetDBContext()
	defer cancel()
